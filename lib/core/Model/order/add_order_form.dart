...
class AddOrderForm {
  ...
  Map<String, dynamic> toJson() {
    developer.log('🔄 AddOrderForm.toJson() - بدء تحويل النموذج إلى JSON',
        name: 'AddOrderForm');
    ...
    developer.log('  - Customer Phone: $customerPhoneNumber',
        name: 'AddOrderForm');
    developer.log('  - Delivery Zone ID: ${data['deliveryZoneId']}',
        name: 'AddOrderForm');
    developer.log('  - Pickup Zone ID: ${data['pickupZoneId']}',
        name: 'AddOrderForm');
    ...
    developer.log('  - Pickup Location: ${pickUpLocation?.toJson()}',
        name: 'AddOrderForm');

    developer.log('✅ AddOrderForm.toJson() - تم إنشاء JSON بنجاح',
        name: 'AddOrderForm');
    return data;
  }
}
